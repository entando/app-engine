...
<section style="margin-top: 1rem">
    ...
    <@s.if test="%{#etichetta1Var != null && !#etichetta1Var.isEmpty()}">
        <div class="row mt-3">
            <div class="form-group col-md-6 col-sm-12">
                <label for="etichetta1"><@s.property value="etichetta1Var"/>&nbsp;<@s.property value="#formVar.data.valore1" /></label>
            </div>
        </div>
    </@s.if>
    ...
    <@s.if test="%{#etichetta2Var != null && !#etichetta2Var.isEmpty()}">
        <div class="row mt-3">
            <div class="form-group col-md-6 col-sm-12">
                <label for="etichetta2"><@s.property value="etichetta2Var"/>&nbsp;<@s.property value="#formVar.data.valore2" /></label>
            </div>
        </div>
    </@s.if>
    ...
    <@s.if test="%{#etichetta3Var != null && !#etichetta3Var.isEmpty()}">
        <div class="row mt-3">
            <div class="form-group col-md-6 col-sm-12">
                <label for="etichetta3"><@s.property value="etichetta3Var"/>&nbsp;<@s.property value="#formVar.data.valore3" /></label>
            </div>
        </div>
    </@s.if>
    ...
    <@s.if test="%{#etichetta4Var != null && !#etichetta4Var.isEmpty()}">
        <div class="row mt-3">
            <div class="form-group col-md-6 col-sm-12">
                <label for="etichetta4"><@s.property value="etichetta4Var"/>&nbsp;<@s.property value="#formVar.data.valore4" /></label>
            </div>
        </div>
    </@s.if>
    ...
    <@s.if test="%{#etichetta5Var != null && !#etichetta5Var.isEmpty()}">
        <div class="row mt-3">
            <div class="form-group col-md-6 col-sm-12">
                <label for="etichetta5"><@s.property value="etichetta5Var"/>&nbsp;<@s.property value="#formVar.data.valore5" /></label>
            </div>
        </div>
    </@s.if>
...
<#--    </form>-->
    ...
    <@s.if test="%{enableFollowUp(#formVar.serial)}">
        <a style="margin-top: 1rem"
