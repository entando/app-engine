        ...
        <div class="panel panel-default"><%-- panel --%>
            ...
            <div class="panel-body"><%-- panel-body --%>
                ...
                <p class="sr-only">
                    ...
                    <%-- inserito per la rowContentList --%>
                ...
                <div class="searchPanel form-group">
                    <div class="well col-md-offset-3 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <wpsf:textfield name="text" id="text" cssClass="form-control" placeholder="%{getText('label.search.topic')}" title="%{getText('label.search.by')} %{getText('label.description')}" />
                            </div>
                        </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" style="padding: 0 0 10px;">
                                    <p class="panel-title" style="text-align: end">
                                        <a data-toggle="collapse" data-parent="#accordion-markup" href="#collapseOne"> <s:text name="label.search.advanced" />
                                        </a>
                                    </p>
                                </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="text-center table-w-10">
                                                <s:text name="name.configure.widget.select" />
                                            </th>
                                            <th><a href="<s:url action="changeContentListOrder">
                                                       <s:param name="text">
                                            ...
                                            <th class="table-w-15">
                                                <a href="<s:url action="changeContentListOrder">
                                                       <s:param name="text">
                                                           <s:property value="#request.text"/>
                                                       </s:param>
                                                       <s:param name="contentIdToken">
                                                   ...
                                                   </s:url>"><s:text name="label.code" /></a></th>
                                            ...
                                            <th class="text-center table-w-15">
                                                <a href="<s:url action="changeContentListOrder">
                                                   ...
                                                   </s:url>"><s:text name="label.lastEdit" /></a></th>
                                        </tr>
                                    </thead>
                                    <tbody>
