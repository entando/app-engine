...
class TestValidateDateAttribute extends AbstractTestContentAttribute {
    ...
    void testValidate_Single_2() throws Throwable {
		try {
			...
			this.initSaveContentAction(contentOnSessionMarker);
			this.addParameter(formFieldName, "10/10/2021");//validation: end range 25/11/2020
			this.executeAction(Action.INPUT);
			this.checkFieldErrors(1, formFieldName);

			this.initSaveContentAction(contentOnSessionMarker);
			this.addParameter(formFieldName, "10/10/2009");//validation: end range 25/11/2020
			this.executeAction(Action.INPUT);
			this.checkFieldErrors(0, formFieldName);
    ...
    void testValidate_CompositeElement() throws Throwable {
		try {
			...
			this.initSaveContentAction(contentOnSessionMarker);
			this.addParameter(formFieldName, "10/10/2041");//validation: end range 10/10/2030
			this.executeAction(Action.INPUT);
			this.checkFieldErrors(1, formFieldName);

			this.initSaveContentAction(contentOnSessionMarker);
			this.addParameter(formFieldName, "10/10/2008");//validation: end range 10/10/2030
			this.executeAction(Action.INPUT);
			this.checkFieldErrors(0, formFieldName);
