...
/**
 * Utility tag for the compilation of the header informations. It verifies the availability of the informations of the
 * specified type.
 *
 * @author E.Santoboni
 */
public class CheckHeadInfoOutputterTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        List<String> infos = headInfo.getInfos(this.getType());
