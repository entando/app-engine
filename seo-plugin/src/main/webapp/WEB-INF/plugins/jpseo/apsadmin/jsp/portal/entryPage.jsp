...
<h1 class="page-title-container">
    <s:if test="strutsAction == 1">
        ...
        <span class="pull-right">
            <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-content="<s:text name="page.edit.help" />" data-placement="left">
            ...
            <s:iterator value="langs" var="lang">
                ...
                <div id="<s:property value="#lang.code"/>" class="tab-pane fade <s:property value="classModifier"/>">
                    ...
                    <div class="form-group<s:property value="#controlGroupErrorClass" />">
                        ...
                        <div class="col-sm-10">
                            <wpsf:textfield name="%{'lang'+#lang.code}" id="%{'lang'+#lang.code}" value="%{titles.get(#lang.code)}" cssClass="form-control" />
