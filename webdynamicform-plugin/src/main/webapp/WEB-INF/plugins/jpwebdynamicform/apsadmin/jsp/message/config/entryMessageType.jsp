            ...
            <h1 class="page-title-container">
                ...
                <span class="pull-right">
                    <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-html="true" title=""
                       data-content="<s:text name="title.messagetype.configuration.help"/>" data-placement="left" data-original-title="">
    ...
    <s:form action="save">
        ...
        <fieldset class="col-xs-12 form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <wpsf:checkbox id="jpwebdynamicform_store" data-toggle="toggle" name="store"
        ...
        <fieldset class="col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <wpsf:checkbox id="jpwebdynamicform_notifiable" data-toggle="toggle" name="notifiable"
                                   cssClass="radiocheck bootstrap-switch"/>
                </div>
            </div>
            <br/>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="jpwebdynamicform_addrectype"><s:text
                    ...
                    <br/>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="jpwebdynamicform_addrecaddress"><s:text
                                name="label.address"/></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <wpsf:textfield cssClass="form-control" id="jpwebdynamicform_addrecaddress"
                                                name="address"/>
