...
public class PageModelAction extends AbstractPageModelAction implements ServletResponseAware {
    ...
    /**
     * Updates the sketch info. The body format must be the same returned by /do/rs/PageModel/frames?code=code
     *
    ...
    public PageModel getPageModelDetailsJson() {
        return this.getPageModelManager().getPageModel(this.getCode());
    }
