...
public class DeleteWidgetResponse extends AbstractPageResponse {
	...
	public DeleteWidgetResponse(ActionSupport actionSupport, IPage draftPage, IPage onlinePage) {
		super();
