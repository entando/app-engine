...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
    ...
    <li>
        <s:if test="null != entityType.typeCode && '' != entityType.typeCode">
            <%--<a href="<s:url action="initEditEntityType" namespace="/do/Entity"><s:param name="entityManagerName"><s:property value="entityManagerName" /></s:param><s:param name="entityTypeCode"><s:property value="entityType.typeCode" /></s:param></s:url>"-->
               title="<s:text name="note.goToSomewhere" />: <s:text name="title.entityTypes.editType.edit" />">--%>
...
<s:form action="saveAttribute" cssClass="form-horizontal">
    ...
    <fieldset class="col-xs-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <wpsf:textfield cssClass="form-control" name="attributeTypeCode"
                                value="%{attributeTypeCode}" disabled="true" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="col-sm-2 control-label" for="attributeName"><s:text
                    name="label.code" />&nbsp;<i class="fa fa-asterisk required-icon"
                         style="position: relative; top: -4px; right: 0px"></i>  <a role="button" tabindex="0"
                         data-toggle="popover" data-trigger="focus" data-html="true" title=""
                         data-placement="top" data-content="<s:text name="page.attributeName.help" />"
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="attributeDescription"><s:text
                   ...
                   data-toggle="popover" data-trigger="focus" data-html="true" title=""
                   data-placement="top" data-content="<s:text name="page.attributeDescription.help" />"
                   data-original-title=""> <span class="fa fa-info-circle"></span></a>
            </label>
            <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn"> <wpsf:submit type="button"
                                     ...
                                     value="%{getText('label.add')}" cssClass="btn btn-primary" />
                        </span>
                    </div>
                </div>
            </div>
