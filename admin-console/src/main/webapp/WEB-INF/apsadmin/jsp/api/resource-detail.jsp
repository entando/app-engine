...
<div id="main" role="main">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <c:set var="resourceUriVar"><wp:info key="systemParam" paramName="applicationBaseURL" />api/legacy/<wp:info key="defaultLang" /><s:if test="null != #apiResourceVar.namespace">/<s:property value="#apiResourceVar.namespace" /></s:if>/<s:property value="#apiResourceVar.resourceName" /></c:set>
