...
class JSessionIdSameSiteCookieProcessorTest {
    ...
    void testJSessionIdCookieGetsSameSiteDefault() {
        ...
        // When
        String header = processor.generateHeader(jsessionCookie, mockRequest);
    ...
    void testOtherCookiesRemainUnchangedWithoutDefault() {
        ...
        // When
        String userHeader = processor.generateHeader(userCookie, mockRequest);
        String sessionHeader = processor.generateHeader(sessionCookie, mockRequest);
        String authHeader = processor.generateHeader(authCookie, mockRequest);
    ...
    void testDefaultPolicyAppliedToOtherCookies() {
        ...
        // When
        String header = processor.generateHeader(userCookie, mockRequest);
    ...
    void testDefaultSameSitePolicyWithJSessionIdOverride() {
        ...
        // When
        String jsessionHeader = processor.generateHeader(jsessionCookie, mockRequest);
        String userHeader = processor.generateHeader(userCookie, mockRequest);
