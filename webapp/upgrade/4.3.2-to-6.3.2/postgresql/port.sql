-- Script for upgrading PostgreSQL port database from Entando 4.3.2 to 6.3.2
-- Not a final target: continue with 6.3.2-to-7.0.0/postgresql/port.sql to reach 7.0.0.
